...
;
    ...
    public Vect3D getPoint(Index i){return m_pos.get(i.x());}
    public Vect3D getPointR(Index i){return m_posR.get(i.x());}
    ...
    {
        m_posR.set(index.x(),m_pos.get(index.x()));
        m_pos.set(index.x(),pos);
    }
